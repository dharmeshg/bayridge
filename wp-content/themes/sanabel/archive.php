...
<div class="site_content">
    ...
    <?php 
    if (is_day()) :
        $this_page_bread = get_the_date();
        $this_page_title = __('Daily Archives: ', 'asalah'). $this_page_bread;
    elseif (is_month()) :
        $this_page_bread = get_the_date(_x('F Y', 'monthly archives date format', 'asalah'));
        $this_page_title = __('Monthly Archives: ', 'asalah'). $this_page_bread;
    elseif (is_year()) :
        $this_page_bread = get_the_date(_x('Y', 'yearly archives date format', 'asalah'));
        $this_page_title = __('Yearly Archives: ', 'asalah'). $this_page_bread;
    else :
        $this_page_bread = __('Archives', 'asalah');
        $this_page_title = __('Archives', 'asalah');
    endif;
        ...
        jQuery(document).ready(function($) {
                ...
                function loadArticle(pageNumber){   
                        ...
                        jQuery.ajax({
                            ...
                            type:'POST',
                            data: "action=infinite_scroll&page_no="+ pageNumber + '&loop_file=content&posts_per_page=<?php echo get_option('posts_per_page'); ?>&post_type=post', 
