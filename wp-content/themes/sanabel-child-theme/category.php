...
<div class="site_content">
    ...
    <?php 
    $this_page_bread = single_cat_title('', false);
    $this_page_title = __('Category Archives: ', 'asalah') . single_cat_title('', false);
        ...
        jQuery(document).ready(function($) {
                ...
                function loadArticle(pageNumber){   
                        ...
                        jQuery.ajax({
                            ...
                            type:'POST',
                            data: "action=infinite_scroll&page_no="+ pageNumber + '&loop_file=content&posts_per_page=<?php echo get_option('posts_per_page'); ?>&post_type=post&cat=<?php echo esc_attr($this_page_bread); ?>', 
