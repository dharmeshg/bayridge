...
<div class="site_content">
    ...
    <?php
    $wp_query = new WP_Query(array('post_type' => 'post', 'category_name' => 'blogs', 'paged' => get_query_var('paged')));
    ?>
    ...
    <div class="new_section blog_section container-fluid">  
        <div class="container">
            ...
            <div class="row content_main_row page_content_main_row <?php echo esc_attr($main_row_class); ?>">
                <div id="new_blog_page" class="blog_main_content_layout blog_posts_wrapper <?php echo esc_attr($blog_wrapper_class); ?> <?php echo asalah_content_class(); ?>">
